...
@section('content')
<section id="login" class="py-24 bg-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="animate__animated animate__fadeInLeft">
                <img src="assets/images/11190420.jpg" alt="Login Illustration"
                ...
                <form class="space-y-6" action="{{ route('login') }}" method="post">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="remember" class="form-checkbox text-cyan-600 rounded">
                    ...
                    <div class="text-center text-sm mt-4">
                        Belum punya akun? <a href="{{ route('register') }}" class="text-cyan-600 hover:underline">Daftar
                            sekarang</a>
                    </div>
                </form>
            </div>
