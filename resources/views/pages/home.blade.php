    ...
    <div class="max-w-6xl mx-auto px-4 md:px-6">
        <div class="text-center mb-10 md:mb-12 animate__animated animate__fadeInUp">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                Kegiatan dan Sosialisasi Teknologi Terbaru Kami
            </h2>
            <p class="text-gray-600 max-w-3xl mx-auto text-base md:text-lg px-4">
                Lihat bagaimana kami berbagi pengetahuan dan memperkenalkan teknologi terkini kepada komunitas dan
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
            ...
            <div
                class="group bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden animate__animated animate__fadeInUp animate__delay-1s">
                <div class="relative overflow-hidden">
                    <img src="assets/images/portfolios/daria-nepriakhina.jpg"
                        alt="Sosialisasi Pembuatan Website untuk UMKM"
                        class="w-full h-[220px] object-cover transition-transform duration-300 group-hover:scale-105">
                    <div
                        class="absolute top-4 right-3 bg-cyan-900 text-white text-xs font-semibold px-3 py-1 rounded-full">
                        SOSIALISASI UMKM
                    </div>
                </div>
                <div class="p-5">
                    <h4 class="text-lg font-semibold text-gray-800 mt-2 mb-2">
                        Sosialisasi Pembuatan Website bagi Usaha Mikro Kecil dan Menengah
                    </h4>
                    <p class="text-base text-gray-700 text-justify">
                        Kami mengadakan sesi sosialisasi di Padang untuk membantu para pelaku UMKM memahami
                        pentingnya
                        website dalam mengembangkan usaha. Kami memberikan panduan langkah demi langkah cara membuat
                        website sederhana namun efektif.
                    </p>
                    <a href="#" class="inline-block mt-4 text-sky-600 text-base font-semibold hover:underline">
            ...
            <div
                class="group bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden animate__animated animate__fadeInUp animate__delay-1-5s">
                <div class="relative overflow-hidden">
                    <img src="assets/images/portfolios/embedsocial.jpg"
                        alt="Kunjungan Pengenalan Teknologi ke Sekolah Vokasi"
                        class="w-full h-[220px] object-cover transition-transform duration-300 group-hover:scale-105">
                    <div
                        class="absolute top-4 right-3 bg-cyan-900 text-white text-xs font-semibold px-3 py-1 rounded-full">
                        KUNJUNGAN SEKOLAH
                ...
                <div class="p-5">
                    <h4 class="text-lg font-semibold text-gray-800 mt-2 mb-2">
                        Kunjungan Pengenalan Teknologi ke Sekolah Menengah Kejuruan di Padang
                    </h4>
                    <p class="text-base text-gray-700 text-justify">
                        Tim kami berkunjung ke sebuah SMK di Padang untuk memperkenalkan berbagai teknologi terkini
                        dalam pengembangan web dan aplikasi. Kami berharap kunjungan ini dapat menginspirasi siswa
                        untuk
                        mendalami dunia teknologi.
                    </p>
                    <a href="#" class="inline-block mt-4 text-sky-600 text-base font-semibold hover:underline">
                        Baca Selengkapnya &nbsp;&rarr;
                    </a>
            ...
            <div
                class="group bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden animate__animated animate__fadeInUp animate__delay-2s">
                <div class="relative overflow-hidden">
                    <img src="assets/images/portfolios/moein-ghezelbash.jpg"
                        alt="Workshop Pengembangan Aplikasi Mobile untuk Komunitas"
                        class="w-full h-[220px] object-cover transition-transform duration-300 group-hover:scale-105">
                    <div
                        class="absolute top-4 right-3 bg-cyan-900 text-white text-xs font-semibold px-3 py-1 rounded-full">
                        WORKSHOP KOMUNITAS
                ...
                <div class="p-5">
                    <h4 class="text-lg font-semibold text-gray-800 mt-2 mb-2">
                        Workshop Singkat Pengembangan Aplikasi Mobile Sederhana untuk Komunitas Lokal
                    </h4>
                    <p class="text-base text-gray-700 text-justify">
                        Kami mengadakan workshop interaktif tentang dasar-dasar pengembangan aplikasi mobile bagi
                        anggota
                        komunitas di sekitar Padang. Tujuannya adalah untuk memberikan keterampilan awal yang dapat
